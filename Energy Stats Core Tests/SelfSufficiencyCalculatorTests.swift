...
final class AbsoluteSelfSufficiencyCalculatorTests: XCTestCase {
    func test_Calculates_When_Some_Grid_Usage() {
        ...
        XCTAssertEqual(breakdown.calculation, "1 - (min(10000.0, max(300.0, 0.0)) / 10000.0")
    }
    ...
    func test_Calculates_When_No_Grid_Usage() {
        ...
        XCTAssertEqual(breakdown.calculation, "1 - (min(10000.0, max(0.0, 0.0)) / 10000.0")
    }
    ...
    func test_Calculates_When_Completely_Grid_Usage() {
        ...
        XCTAssertEqual(breakdown.calculation, "1 - (min(10000.0, max(10000.0, 0.0)) / 10000.0")
    }
    ...
    func test_Calculates_When_Grid_Usage_Over_Load() {
        ...
        XCTAssertEqual(result, 0)
        XCTAssertEqual(breakdown.calculation, "1 - (min(10000.0, max(11000.0, 0.0)) / 10000.0")
    }
    ...
    func test_Calculates_When_Grid_Negative() {
        ...
        XCTAssertEqual(result, 1)
        XCTAssertEqual(breakdown.calculation, "1 - (min(10000.0, max(-50.0, 0.0)) / 10000.0")
    }
    ...
    func test_Calculates_When_No_Loads() {
        ...
        XCTAssertEqual(result, 0)
        XCTAssertEqual(breakdown.calculation, "")
    }
}
