...
public struct SolcastSiteResponse: Decodable {
    ...
    public init(name: String, resourceId: String, capacity: Double, longitude: Double, latitude: Double, azimuth: Double, tilt: Double, lossFactor: Double?, dcCapacity: Double?, installDate: Date?) {
        self.name = name
